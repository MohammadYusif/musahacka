        ...
        <FadeIn>
          <Card className="border-0 shadow-xl shadow-bark-900/5 bg-white/90 backdrop-blur rounded-2xl overflow-hidden">
            ...
            <CardHeader className="text-center pt-8 pb-2">
              ...
              <CardTitle className="text-2xl font-bold text-bark-800" style={{ fontFamily: "var(--font-display)" }}>{t("loginTitle")}</CardTitle>
              <CardDescription className="text-sm mt-1 text-bark-600">{t("loginSubtitle")}</CardDescription>
            </CardHeader>
            ...
            <CardContent className="pt-6">
              <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      id="email" type="email" placeholder={tc("emailPlaceholder")} autoComplete="email"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      id="password" type={showPassword ? "text" : "password"} placeholder={tc("passwordPlaceholder")} autoComplete="current-password"
                ...
                <Button type="submit" className="w-full h-11 rounded-xl font-semibold bg-brand-600 hover:bg-brand-700 text-ivory-100 border-0 shadow-md shadow-brand-600/20" disabled={loading}>
                  {loading ? (
              ...
              <Button variant="outline" className="w-full h-11 rounded-xl border-ivory-300 text-bark-700 hover:bg-ivory-100" onClick={() => signIn("google", { callbackUrl: `/${locale}/dashboard` })}>
            ...
            <CardFooter className="justify-center pb-8">
              <p className="text-sm text-bark-500">
                {t("noAccount")}{" "}
                <Link href="/register" className="text-brand-600 font-semibold hover:underline underline-offset-4">{tc("register")}</Link>
              </p>
            </CardFooter>
          </Card>
        </FadeIn>
